package com.rungnueng.com.uikotlin.Adapters
...
class SlideImageAdapter(private val context: Context, private val imageModelArrayList: ArrayList<SlideImageModel>) : PagerAdapter() {
